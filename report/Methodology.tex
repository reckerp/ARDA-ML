...
\begin{enumerate}
    \item Airplane
        \begin{itemize}
            \item \citetitle{zotero-40}
            \item \citetitle{zotero-34}
            \item \citetitle{zotero-37}
        \end{itemize}
    \item Boat
        \begin{itemize}
            \item \citetitle{zotero-43}
            \item \citetitle{zotero-47}
            \item \citetitle{zotero-45}
        \end{itemize}
    \item Car
        \begin{itemize}
            \item \citetitle{zotero-54}
            \item \citetitle{zotero-52}
            \item \citetitle{zotero-56}
        \end{itemize}
    \item Dog
        \begin{itemize}
            \item \citetitle{zotero-22}
            \item \citetitle{zotero-19}
            \item \citetitle{zotero-16}
        \end{itemize}
    \item Person
        \begin{itemize}
            \item \citetitle{zotero-25}
            \item \citetitle{zotero-29}
            \item \citetitle{zotero-27}
        \end{itemize}
\end{enumerate}
\\
